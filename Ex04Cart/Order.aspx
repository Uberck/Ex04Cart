        ...
        <form id="form1" runat="server" class="form-horizontal">
            ...
            <div class="row"><%-- row 1 --%>
                <div class="col-sm-8"><%-- product drop down and info column --%>
                    ...
                    <!-- Data Source -->
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HalloweenConnection %>" SelectCommand="SELECT [LongDescription], [ShortDescription], [Name], [ProductID], [ImageFile], [UnitPrice] FROM [Products]"></asp:SqlDataSource>
                    <!-- End Data Source -->
                    <div class="form-group">
